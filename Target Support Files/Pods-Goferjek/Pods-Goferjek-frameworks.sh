...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AGPullView/AGPullView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SocialLoginsIntegration/SocialLoginsIntegration.framework"
